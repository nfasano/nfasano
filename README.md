...
* [Other Coding Projects](#other-coding-projects) 
    * [1) Colosseum ticket tracker and alert system](#1-colosseum-ticket-tracker-and-alert-system) 
    * [2) Bash script for executing code through the Slurm scheduler](#2-bash-script-for-executing-code-through-the-slurm-scheduler) 
    * [3) Shopping list in Google sheets](#3-shopping-list-in-google-sheets) 
